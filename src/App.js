...
function WrappedApp() {
    ...
    React.useEffect(() => {
        if (pathName === "/about" || pathName === "/faq" || pathName === "/map" || pathName === "/explorer")
            return;
        if (wallet == null) {
            setSwapper(null);
            setProvider(null);
