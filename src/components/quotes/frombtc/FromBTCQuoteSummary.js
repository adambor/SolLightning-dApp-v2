        ...
        const stateChange = (state) => {
            ...
            if (state === FromBTCSwapState.CLAIM_COMMITED) {
                ...
                if (!paymentSubscribed) {
                    props.quote.waitForPayment(abortController.signal, null, (txId, confirmations, confirmationTarget, txEtaMs) => {
