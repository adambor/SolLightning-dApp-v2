...
export function SwapForGasScreen(props) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Topbar, { selected: 3, enabled: true }), _jsx("div", Object.assign({ className: "d-flex flex-column flex-fill justify-content-center align-items-center text-white" }, { children: _jsx("div", Object.assign({ className: "quickscan-summary-panel d-flex flex-column flex-fill" }, { children: _jsxs("div", Object.assign({ className: "p-3 d-flex flex-column tab-bg border-0 card mb-3" }, { children: [error ? (_jsxs(Alert, Object.assign({ variant: "danger", className: "mb-3" }, { children: [_jsx("p", { children: _jsx("strong", { children: "Loading error" }) }), error] }))) : "", success ? (_jsxs(Alert, Object.assign({ variant: "success", className: "mb-3" }, { children: [_jsx("p", { children: _jsx("strong", { children: "Swap successful" }) }), "Successfully swapped ", toHumanReadableString(swapData.getInAmount(), btcCurrency), " BTC to ", swapAmountSol, " SOL"] }))) : "", _jsx(Alert, Object.assign({ className: "text-center mb-3 d-flex align-items-center flex-column", show: swapData != null && !success && !error, variant: "success", closeVariant: "white" }, { children: _jsxs("label", { children: ["Swap for gas is a trusted service allowing you to swap BTC-LN to SOL, so you can then cover the gas fees of a trustless atomiq swap. Note that this is a trusted service and is therefore only used for very small amounts! You can read more about it in our ", _jsx("a", Object.assign({ href: "/faq?tabOpen=11" }, { children: "FAQ" })), "."] }) })), loading ? (_jsxs("div", Object.assign({ className: "d-flex flex-column align-items-center justify-content-center tab-accent" }, { children: [_jsx(Spinner, { animation: "border" }), "Creating gas swap..."] }))) : "", swapData != null ? (_jsxs("div", Object.assign({ className: "mb-3 tab-accent-p3 text-center" }, { children: [_jsx(ValidatedInput, { type: "number", textEnd: (_jsxs("span", Object.assign({ className: "text-white font-bigger d-flex align-items-center" }, { children: [_jsx("img", { src: btcCurrency.icon, className: "currency-icon" }), "BTC"] }))), disabled: true, size: "lg", value: toHumanReadableString(swapData.getInAmount(), btcCurrency), onChange: () => { }, placeholder: "Input amount" }), _jsx(Icon, { size: 24, icon: ic_south, className: "my-1" }), _jsx(ValidatedInput, { type: "number", textEnd: (_jsxs("span", Object.assign({ className: "text-white font-bigger d-flex align-items-center" }, { children: [_jsx("img", { src: nativeCurrency.icon, className: "currency-icon" }), nativeCurrency.ticker] }))), disabled: true, size: "lg", value: toHumanReadableString(swapData.getOutAmount(), nativeCurrency), onChange: () => { }, placeholder: "Output amount" })] }))) : "", quoteTimeRemaining === 0 || success ? "" : (_jsxs("div", Object.assign({ className: "mb-3 tab-accent" }, { children: [_jsx(Overlay, Object.assign({ target: showCopyOverlay === 1 ? copyBtnRef.current : (showCopyOverlay === 2 ? qrCodeRef.current : null), show: showCopyOverlay > 0, placement: "top" }, { children: (props) => (_jsx(Tooltip, Object.assign({ id: "overlay-example" }, props, { children: "Address copied to clipboard!" }))) })), _jsx("div", Object.assign({ ref: qrCodeRef }, { children: _jsx(QRCodeSVG, { value: swapData.getQrData(), size: 300, includeMargin: true, className: "cursor-pointer", onClick: () => {
                                                copy(2);
                                            } }) })), _jsx("label", { children: "Please pay this lightning network invoice" }), _jsx(ValidatedInput, { type: "text", value: swapData.getAddress(), textEnd: (_jsx("a", Object.assign({ href: "javascript:void(0);", ref: copyBtnRef, onClick: () => {
                                                copy(1);
                                            } }, { children: _jsx(Icon, { icon: clipboard }) }))), inputRef: textFieldRef })] }))), _jsxs("div", Object.assign({ className: !success && !loading ? "d-flex flex-column tab-accent" : "d-none" }, { children: [quoteTimeRemaining === 0 ? (_jsx("label", { children: "Gas swap expired!" })) : (_jsxs("label", { children: ["Gas swap expires in ", quoteTimeRemaining, " seconds"] })), _jsx(ProgressBar, { animated: true, now: quoteTimeRemaining, max: initialQuoteTimeout, min: 0 })] })), quoteTimeRemaining === 0 && !loading && !success ? (_jsx(Button, Object.assign({ onClick: createSwap, variant: "secondary", className: "mt-3" }, { children: "New gas swap" }))) : "", success && (state === null || state === void 0 ? void 0 : state.returnPath) != null ? (_jsx(Button, Object.assign({ onClick: () => {
