...
export function FeeSummaryScreen(props) {
    ...
    if (props.swap instanceof FromBTCLNSwap) {
        ...
        return (_jsxs("div", Object.assign({ className: className }, { children: [_jsx(FeePart, { text: "Amount", currency: currency, amount: props.swap.getOutAmountWithoutFee() }), _jsx(FeePart, { text: "Swap fee", isApproximate: isApproximate, currency: currency, amount: props.swap.getFee(), feePPM: getFeePct(props.swap, 1), feeBase: props.swap.pricingInfo.satsBaseFee, feeCurrency: btcCurrency }), _jsxs("div", Object.assign({ className: "d-flex fw-bold border-top border-light font-bigger" }, { children: [_jsx("span", { children: "Total:" }), _jsxs("span", Object.assign({ className: "ms-auto d-flex align-items-center" }, { children: [_jsx("img", { src: currency.icon, className: "currency-icon-small" }), isApproximate ? "~" : "", toHumanReadableString(props.swap.getOutAmount(), currency), " ", currency.ticker] }))] }))] })));
    }
    return null;
}
